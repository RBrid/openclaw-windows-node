...
/// Picked from the Debug page so engineers can compare the legacy gateway WebView
/// and the native WinUI chat surfaces side-by-side without flipping the global setting.
/// </summary>
public enum ChatSurfaceOverride
{
    ...
    ForceLegacy,
    /// <summary>Force the native WinUI 3 chat surface.</summary>
    ForceNative,
}

/// <summary>
/// Process-wide debug overrides for which chat surface (legacy gateway WebView
/// or native WinUI) renders inside each chat container. Not persisted — these
